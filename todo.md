...
## Database Course Management (Phase 11)
- [x] Create courses table in database schema
- [x] Add course management procedures to tRPC router
- [x] Create Admin Panel UI for managing courses
- [x] Add course CRUD operations (Create, Read, Update, Delete)
- [ ] Update Home page to fetch courses from database
- [ ] Update enrollment form to use courses from database
- [x] Test course management functionality (16 tests passing)
